...
/**
 * a ExactLinearLayout is a layout that measure size by it's child view's exact measurement
 * @author 7heaven
 *
 */
public class ExactLinearLayout extends FrameLayout {

	public ExactLinearLayout(Context context){
		super(context);
	}
	
	public ExactLinearLayout(Context context, AttributeSet attrs){
		super(context, attrs);
	}
